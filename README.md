...
<p>Compiling individual parts is automated by sh scripts.</p>
<h2>1. Compile all libraries</h2>
<p>To compile each library: log2database, sha256generator, strconverter, use the compile.sh in relevant directories.</p>
<p>Received libraries:</p>
<img src=".\readmedata\howToCompileAllLibs.png">
<h2>2. Building a project</h2>
<p>Go to the 'main' directory and run 'compile.sh'</p>
</div>
...
<p>Displays all entries in lexicographic order. You can switch between entries using the up and down arrows, PageUp and PageDown, Home and End.</p>
